...
```sql
postgres@localhost:postgres> select * from processed_events_aggregated order by num_trips desc limit 3;
+---------------------+--------------+-----------+
| window_start        | pulocationid | num_trips |
|---------------------+--------------+-----------|
...
```sql
postgres@localhost:postgres> select * from processed_events_aggregated order by total_tips desc limit 3;
+---------------------+---------------------+--------------+------------+
| window_start        | window_end          | pulocationid | total_tips |
|---------------------+---------------------+--------------+------------|
| 2025-10-16 18:00:00 | 2025-10-16 19:00:00 | 75           | 176.29     |
| 2025-10-13 09:00:00 | 2025-10-13 10:00:00 | 74           | 168.23     |
| 2025-10-26 16:00:00 | 2025-10-26 17:00:00 | 74           | 165.04     |
+---------------------+---------------------+--------------+------------+
```
